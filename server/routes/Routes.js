...
const {registerVoter, loginVoter, getVoter } = require("../controller/voterController");
const {addElection, getElection, getElections, updateElection, removeElection, getCandidatesOfElection, getElectionVoters} = require("../controller/electionController")
const {addCandidate,getCandidate,removeCandidate,voteCandidate} = require("../controller/candidateController")
